...
// GET by lastName - Create an endpoint in the same code for getting all users with a particular Last Name.
...
//GET by DOB - Create an endpoint in the same code for sorting users by date of birth.
...
router.delete("/:email", (req, res) => {
  ...
  //for delete user from cmd write
